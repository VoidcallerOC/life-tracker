...
import { PINNED, WEEK_OF } from "@/lib/os/priorities";
  ...
  return (
    <section className="rounded-xl border border-border bg-surface p-4">
      <div className="flex items-baseline justify-between gap-3">
        <h2 className="text-base font-semibold tracking-tight text-fg">This week — do not skip</h2>
        <span className="text-xs text-muted">{WEEK_OF}</span>
      </div>
      <p className="mt-1 text-sm text-muted">
        Close Infinite Heroes before you add names. Care plans on the four live shops. Card shops only until two more say yes.
      </p>
