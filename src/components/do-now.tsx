...
import { DeadlinePill } from "@/components/ui/badge";
import { WeekPin } from "@/components/week-pin";
import { useLifeStore } from "@/lib/life-store";
import { buildQueue, countOverdue, laneLabel } from "@/lib/queue";
import { bucketFor, bucketLabel } from "@/lib/dates";
    ...
    <div className="space-y-4">
      {!coachDismissed ? (
        <section className="rounded-xl border border-border bg-surface p-4">
          <h2 className="font-display text-lg text-fg">How not to mess this up</h2>
      ...
      {queue.length === 0 ? (
        <div className="rounded-xl border border-dashed border-border bg-surface px-5 py-10 text-center">
          <h2 className="font-display text-2xl text-fg">Board is clear</h2>
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <h3 className="mt-1 font-display text-xl leading-snug text-fg">{item.title}</h3>
                  </div>
